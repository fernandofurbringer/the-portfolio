...
export default function TakenCourses({
    takenCourses = [],  // Define um valor padrão vazio para evitar problemas
    coursePage,
    title
}: {
    takenCourses?: TakenCourses[],  // Adicione o sinal de interrogação para permitir undefined
    coursePage: string,
    title: string
}) {
    // Se takenCourses for undefined, defina como array vazio
    const courses = Array.isArray(takenCourses) ? takenCourses : [];
